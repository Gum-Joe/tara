...
export const TARA_HOME: string = process.env.TARA_HOME ? process.env.TARA_HOME : process.cwd();
// Windows settings
...
export const TARA_CONFIG: string = path.resolve(TARA_HOME, "./src/config"); // Should be $HOME/.tara
...
export const TARA_PACKAGES: string = path.resolve(TARA_HOME, "./src/packages");
export const THEME_FILE: string = path.resolve(TARA_HOME, "./src/css/get-theme.scss");
